...
icon = Image.open("download (8).png")
...
client = pymongo.MongoClient("mongodb+srv://rajasekar:XXwqfjaHvvgktXsd@cluster0.dbe7tgx.mongodb.net/?retryWrites=true&w=majority")
db = client.sample_airbnb
col = db.listingsAndReviews

# READING THE CLEANED DATAFRAME
df = pd.read_csv('Airbnb_dataorg.csv')
...
if selected == "Overview":
    tab1,tab2 = st.tabs(["$\huge 📝 DataFrame $", "$\huge🚀 INSIGHTS $"])
    ...
    with tab2:
        ...
        with col2:
            ...
            fig.update_traces(textposition='outside', textinfo='value+label',hole=0.4)
            st.plotly_chart(fig,use_container_width=True)
            ...
            fig.update_layout(geo=dict(bgcolor='#0E1117'),width=600, height=600,paper_bgcolor='#0E1117',font=dict(color='white'),)
            st.plotly_chart(fig,use_container_width=True)
...
if selected == "Explore":
    ...
    with col2:
        ...
        fig.update_layout(geo=dict(bgcolor='#0E1117'),width=500, height=400,paper_bgcolor='#0E1117',font=dict(color='white'),)
